...
public:
    ...
    static int64_t get_max_8b();
    static int64_t get_max_7b();
    static int64_t get_max_16b();
    static int64_t get_max_15b();
    static uint64_t get_max_32b();
    static int64_t get_max_31b();
    static uint64_t get_max_64b();
    static int64_t get_max_63b();
